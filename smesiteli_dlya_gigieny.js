...
const prodObj = {
  ...
  "Тип товаров": 'Смеситель для ванны',
  "Теги": '',
  "Облагается налогом": '',
  "Заголовок": '',
  "META Keywords": '',
...
async function main() {
  const urls = await readUrlsFromFile('./links/smesiteli-dlya-gigienyAll.txt');
  const allProducts = [];
  ...
  const csvFilename = `./result/smesiteli-dlya-gigieny.csv`;
